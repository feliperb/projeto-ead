...
import com.ead.authuser.validators.PasswordConstraint;
...
public record UserRecordDto(
        ...
        @NotBlank(groups = UserView.RegistrationPost.class, message = "Emails is mandatory")
        ...
        @PasswordConstraint(groups = UserView.RegistrationPost.class)
        @JsonView(UserView.RegistrationPost.class)
        String password,
        ...
        @NotBlank(groups = UserView.PasswordPut.class, message = "New Password is mandatory")
